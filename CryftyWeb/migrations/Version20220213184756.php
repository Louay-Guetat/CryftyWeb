 ...
 */
final class Version20220213184756 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog_article ADD title VARCHAR(255) NOT NULL, ADD subtitre VARCHAR(255) NOT NULL, ADD text VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog_article DROP title, DROP subtitre, DROP text');
