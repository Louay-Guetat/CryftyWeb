 ...
 */
final class Version20220218011221 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart CHANGE date_creation date_creation VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart CHANGE date_creation date_creation DATETIME NOT NULL');
