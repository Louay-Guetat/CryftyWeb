 ...
 */
final class Version20220216151826 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE block DROP INDEX UNIQ_831B9722712520F3, ADD INDEX IDX_831B9722712520F3 (wallet_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE block DROP INDEX IDX_831B9722712520F3, ADD UNIQUE INDEX UNIQ_831B9722712520F3 (wallet_id)');
