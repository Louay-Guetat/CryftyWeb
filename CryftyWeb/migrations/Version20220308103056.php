 ...
 */
final class Version20220308103056 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE blog_article (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) DEFAULT NULL, contents VARCHAR(255) DEFAULT NULL, category VARCHAR(255) DEFAULT NULL, author VARCHAR(255) DEFAULT NULL, date DATE DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE blog_comment (id INT AUTO_INCREMENT NOT NULL, article_id INT DEFAULT NULL, user_id INT DEFAULT NULL, comment VARCHAR(255) NOT NULL, post_date DATETIME NOT NULL, likes INT NOT NULL, dislikes INT NOT NULL, INDEX IDX_7882EFEF7294869C (article_id), INDEX IDX_7882EFEFA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cart (id INT AUTO_INCREMENT NOT NULL, wallets_id INT DEFAULT NULL, client_id_id INT DEFAULT NULL, date_creation DATETIME NOT NULL, total DOUBLE PRECISION NOT NULL, UNIQUE INDEX UNIQ_BA388B7C3B43BA3 (wallets_id), UNIQUE INDEX UNIQ_BA388B7DC2902E0 (client_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, creation_date DATETIME NOT NULL, nbr_nft INT NOT NULL, nbr_sub_category INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, sender_id INT DEFAULT NULL, conversation_id INT NOT NULL, contenu VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_B6BD307FF624B39D (sender_id), INDEX IDX_B6BD307F9AC0396 (conversation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE nft (id INT AUTO_INCREMENT NOT NULL, currency_id INT DEFAULT NULL, owner_id INT DEFAULT NULL, category_id INT DEFAULT NULL, sub_category_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, creation_date DATETIME NOT NULL, image VARCHAR(255) NOT NULL, likes INT NOT NULL, INDEX IDX_D9C7463C38248176 (currency_id), INDEX IDX_D9C7463C7E3C61F9 (owner_id), INDEX IDX_D9C7463C12469DE2 (category_id), INDEX IDX_D9C7463CF7BFE87C (sub_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE nft_comment (id INT AUTO_INCREMENT NOT NULL, nft_id INT DEFAULT NULL, user_id INT DEFAULT NULL, comment VARCHAR(255) NOT NULL, post_date DATETIME NOT NULL, likes INT NOT NULL, dislikes INT NOT NULL, INDEX IDX_9D8D8644E813668D (nft_id), INDEX IDX_9D8D8644A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE node (id INT AUTO_INCREMENT NOT NULL, node_label VARCHAR(255) NOT NULL, coin_code VARCHAR(5) NOT NULL, node_reward DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE transfer (id INT AUTO_INCREMENT NOT NULL, sender_id_id INT DEFAULT NULL, reciever_id_id INT DEFAULT NULL, amount DOUBLE PRECISION NOT NULL, transfer_date DATETIME NOT NULL, INDEX IDX_4034A3C06061F7CF (sender_id_id), INDEX IDX_4034A3C0AE06B8F9 (reciever_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, is_active TINYINT(1) NOT NULL, type VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE wallet (id INT AUTO_INCREMENT NOT NULL, node_id_id INT DEFAULT NULL, client_id INT NOT NULL, wallet_address VARCHAR(255) NOT NULL, balance DOUBLE PRECISION NOT NULL, wallet_label VARCHAR(255) NOT NULL, wallet_image_file_name VARCHAR(255) DEFAULT NULL, is_active TINYINT(1) NOT NULL, is_main TINYINT(1) NOT NULL, INDEX IDX_7C68921F66EF0CAB (node_id_id), INDEX IDX_7C68921F19EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE blog_comment ADD CONSTRAINT FK_7882EFEF7294869C FOREIGN KEY (article_id) REFERENCES blog_article (id)');
        $this->addSql('ALTER TABLE blog_comment ADD CONSTRAINT FK_7882EFEFA76ED395 FOREIGN KEY (user_id) REFERENCES client (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog_comment DROP FOREIGN KEY FK_7882EFEF7294869C');
        ...
        $this->addSql('ALTER TABLE client_nft DROP FOREIGN KEY FK_FE63D59819EB6921');
        $this->addSql('ALTER TABLE nft DROP FOREIGN KEY FK_D9C7463C7E3C61F9');
        $this->addSql('ALTER TABLE nft_client DROP FOREIGN KEY FK_88DC075919EB6921');
        ...
        $this->addSql('ALTER TABLE client_nft DROP FOREIGN KEY FK_FE63D598E813668D');
        $this->addSql('ALTER TABLE nft_cart DROP FOREIGN KEY FK_48325459E813668D');
        $this->addSql('ALTER TABLE nft_client DROP FOREIGN KEY FK_88DC0759E813668D');
