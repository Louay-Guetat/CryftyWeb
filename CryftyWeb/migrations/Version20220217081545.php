 ...
 */
final class Version20220217081545 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE wallet DROP INDEX UNIQ_7C68921F66EF0CAB, ADD INDEX IDX_7C68921F66EF0CAB (node_id_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE wallet DROP INDEX IDX_7C68921F66EF0CAB, ADD UNIQUE INDEX UNIQ_7C68921F66EF0CAB (node_id_id)');
