 ...
 */
final class Version20220213191012 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog_article CHANGE subtitre subtitle VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog_article ADD subtitre VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP subtitle, CHANGE title title VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE text text VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
