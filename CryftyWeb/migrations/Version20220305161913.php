 ...
 */
final class Version20220305161913 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client_nft (client_id INT NOT NULL, nft_id INT NOT NULL, INDEX IDX_FE63D59819EB6921 (client_id), INDEX IDX_FE63D598E813668D (nft_id), PRIMARY KEY(client_id, nft_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
