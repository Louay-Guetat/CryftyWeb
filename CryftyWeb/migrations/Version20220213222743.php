 ...
 */
final class Version20220213222743 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog_article DROP date');
    }
