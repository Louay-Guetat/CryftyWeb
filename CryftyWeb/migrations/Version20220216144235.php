 ...
 */
final class Version20220216144235 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE block ADD wallet_id INT NOT NULL');
        $this->addSql('ALTER TABLE block ADD CONSTRAINT FK_831B9722712520F3 FOREIGN KEY (wallet_id) REFERENCES wallet (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_831B9722712520F3 ON block (wallet_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_831B9722712520F3 ON block');
        $this->addSql('ALTER TABLE block DROP wallet_id, CHANGE hash hash VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
