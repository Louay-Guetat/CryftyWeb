 ...
 */
final class Version20220213222541 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog_article ADD category VARCHAR(255) NOT NULL');
    }
