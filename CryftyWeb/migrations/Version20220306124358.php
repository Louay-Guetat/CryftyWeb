 ...
 */
final class Version20220306124358 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE wallet (id INT AUTO_INCREMENT NOT NULL, node_id_id INT DEFAULT NULL, client_id INT NOT NULL, wallet_address VARCHAR(255) NOT NULL, balance DOUBLE PRECISION NOT NULL, wallet_label VARCHAR(255) NOT NULL, wallet_image_file_name VARCHAR(255) DEFAULT NULL, is_active TINYINT(1) NOT NULL, INDEX IDX_7C68921F66EF0CAB (node_id_id), INDEX IDX_7C68921F19EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
