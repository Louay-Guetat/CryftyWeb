 ...
 */
final class Version20220301194648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE wallet ADD is_active TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE node CHANGE node_label node_label VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE coin_code coin_code VARCHAR(5) NOT NULL COLLATE `utf8mb4_unicode_ci`');
