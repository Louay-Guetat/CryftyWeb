 ...
 */
final class Version20220305173720 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE nft_client (nft_id INT NOT NULL, client_id INT NOT NULL, INDEX IDX_88DC0759E813668D (nft_id), INDEX IDX_88DC075919EB6921 (client_id), PRIMARY KEY(nft_id, client_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
